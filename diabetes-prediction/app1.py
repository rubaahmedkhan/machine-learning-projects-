...
# spilt the data into input and target variable
X = diabetes_df.drop('Outcome', axis=1)
Y = diabetes_df['Outcome']

# scale the input variables using StandardScalar
...
test_acc = accuracy_score(test_y_pred, X_test)
...
def app():
    ...
    # display some summary statics about the dataset
    ...
    st.write(f'Train test accuracy: {train_acc:,.2f}')
